...
function startGame() {
    ...
    setting.score = 0; //Обнуление очков в начале игры
    setting.start = true;
...
function moveEnemy() {
    ...
    enemy.forEach(function (item) {
        //carRect - получает параметры автомобиля
...
// метод getBoundingClientRect Возвращает размеры и позиции элемента в виде объекта